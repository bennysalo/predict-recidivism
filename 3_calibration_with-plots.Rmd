...
make_quintiles <- function(x) {
  ...
  quintiles    <- cut(x, breaks = quint_breaks, include.lowest = TRUE, labels = FALSE)
  quintiles
}
...
```{r}
calibr_data <- data.frame(predictions, bins, reoffenceThisTerm = test_set$reoffenceThisTerm, 
