Table 3. Discrimination in training and test sets.
================
Benny Salo
2019-04-05
...
We edit Table 3 below. We rmove the model\_name column and round **AUC** values to 3 decimal places and **d**-values to two decimal places.
