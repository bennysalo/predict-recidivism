...
write_mod_names <- function(model_grid) {
  ...
  o <- ifelse(o == "reoffenceThisTerm", "gen_", "viol_")
  p <- ifelse(p == "static_preds", "stat_",
              ifelse(p == "rita_items", "dyn_",
                     ifelse(p == "static_n_rita", "all-begin_",
                            "incl-term_")))
...
saveRDS(train_mods_rf, file = "train_mods_rf")
rm(train_mods_rf)
