...
```
    ...
    ## Time difference of 28.46817 mins

Name the trained models according to the names in the grid used to specify models.

``` r
names(trained_mods_glm_4) <- glm_grid$model_name
```

``` r
devtools::wd()
saveRDS(trained_mods_glm_4, "not_public/trained_mods_glm_4.rds")
```
...
```
    ...
    ## [52] kernlab_0.9-27     munsell_0.5.0      pls_2.7-0         
