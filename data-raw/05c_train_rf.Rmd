...
Checks
```{r}
# All entries in rf_grid$mtry_seq should be of class numeric
all(purrr::map_chr(rf_grid$mtry_seq, class) == "integer")
# All entries in rf_grid$mtry_seq should have length 7.
all(purrr::map_chr(rf_grid$mtry_seq, length) == 7)
